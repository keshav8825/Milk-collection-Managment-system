...
sql = "update FARMER set  f_name='" + Text12.Text + "',father_name='" + Text13.Text + "',ph_no=" + Text14.Text + ",aadhar=" + Text15.Text + ",address='" + RichTextBox2.Text + "',P_ID='" + Text21.Text + "' WHERE F_ID='" + Text11.Text + "'"
Set r = c.Execute(sql)
sql = "update bank_details SET BANK_NAME='" + Text16.Text + "',acc_no=" + Text18.Text + ",Ifsc='" + Text19.Text + "',acc_holder='" + Text17.Text + "',branch_name='" + Text20.Text + "' WHERE F_ID='" + Text11.Text + "'"
Set r = c.Execute(sql)
