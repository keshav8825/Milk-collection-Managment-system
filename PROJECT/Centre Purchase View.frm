...
Begin VB.Form CentrePurchaseView 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   "Provider=MSDAORA.1;User ID=DAIRY/MOON;Persist Security Info=False"
      OLEDBString     =   "Provider=MSDAORA.1;User ID=DAIRY/MOON;Persist Security Info=False"
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
